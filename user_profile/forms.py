...
from .models import (StudentProfile, Hackathon, Education, KT, Skill, Internship,
                     Project, Committee, BeProject, ResearchPaper)
...
class InternshipForm(forms.ModelForm):
    class Meta:
        model = Internship
        fields = ['company', 'Position', 'Loc', 'From', 'To', 'desc', 'Certificate',
